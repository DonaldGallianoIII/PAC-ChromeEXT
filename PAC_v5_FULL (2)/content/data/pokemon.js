...
PAC.Data.POKEMON_DATA = {
  ...
  "BASTIODON": { rarity: "rare", types: ["rock", "fossil", "steel"], additional: true, regional: false, stars: 2 },
  ...
  "BOLTUND": { rarity: "uncommon", types: ["electric", "field"], additional: true, regional: false, stars: 2 },
  ...
  "BUNNELBY": { rarity: "rare", types: ["normal", "ground"], additional: true, regional: false, stars: 1 },
  ...
  "DIGGERSBY": { rarity: "rare", types: ["normal", "ground"], additional: true, regional: false, stars: 2 },
  ...
  "DUBWOOL": { rarity: "uncommon", types: ["normal", "field"], additional: true, regional: false, stars: 2 },
  ...
  "GOGOAT": { rarity: "epic", types: ["grass", "field"], additional: true, regional: false, stars: 2 },
  ...
  "GREATTUSK": { rarity: "unique", types: ["ground", "fighting", "fossil"], additional: false, regional: false, stars: 1 },
  ...
  "KANGASKHAN": { rarity: "unique", types: ["fighting", "normal", "monster"], additional: false, regional: false, stars: 1 },
  ...
  "LECHONK": { rarity: "uncommon", types: ["normal", "field", "gourmet"], additional: true, regional: false, stars: 1 },
  ...
  "MUDBRAY": { rarity: "epic", types: ["ground", "field"], additional: true, regional: false, stars: 1 },
  "MUDKIP": { rarity: "common", types: ["water", "ground"], additional: false, regional: true, stars: 1 },
  "MUDSDALE": { rarity: "epic", types: ["ground", "field"], additional: true, regional: false, stars: 2 },
  ...
  "OINKOLOGNE": { rarity: "uncommon", types: ["normal", "field", "gourmet"], additional: true, regional: false, stars: 2 },
  "OINKOLOGNEFEMALE": { rarity: "uncommon", types: ["normal", "field", "gourmet"], additional: true, regional: false, stars: 2 },
  ...
  "SCATTERBUG": { rarity: "hatch", types: ["bug", "amorphous"], additional: false, regional: false, stars: 1 },
  ...
  "SHIELDON": { rarity: "rare", types: ["rock", "fossil", "steel"], additional: true, regional: false, stars: 1 },
  ...
  "SKIDDO": { rarity: "epic", types: ["grass", "field"], additional: true, regional: false, stars: 1 },
  ...
  "SPEWPA": { rarity: "hatch", types: ["bug", "amorphous"], additional: false, regional: false, stars: 1 },
  ...
  "TAUROS": { rarity: "unique", types: ["wild", "normal", "field"], additional: false, regional: false, stars: 1 },
  "TAUROSAQUABREED": { rarity: "unique", types: ["wild", "water", "fighting"], additional: false, regional: true, stars: 1 },
  "TAUROSBLAZEBREED": { rarity: "unique", types: ["wild", "fire", "fighting"], additional: false, regional: true, stars: 1 },
  "TAUROSCOMBATBREED": { rarity: "unique", types: ["wild", "fighting", "field"], additional: false, regional: true, stars: 1 },
  ...
  "VIVILLON": { rarity: "hatch", types: ["bug", "amorphous", "sound"], additional: false, regional: false, stars: 1 },
  "VIVILLONARCHIPELAGO": { rarity: "hatch", types: ["bug", "amorphous", "fighting"], additional: false, regional: false, stars: 1 },
  "VIVILLONCONTINENTAL": { rarity: "hatch", types: ["bug", "amorphous", "fossil"], additional: false, regional: false, stars: 1 },
  "VIVILLONELEGANT": { rarity: "hatch", types: ["bug", "amorphous", "psychic"], additional: false, regional: false, stars: 1 },
  "VIVILLONFANCY": { rarity: "hatch", types: ["bug", "amorphous", "fairy"], additional: false, regional: false, stars: 1 },
  "VIVILLONGARDEN": { rarity: "hatch", types: ["bug", "amorphous", "grass"], additional: false, regional: false, stars: 1 },
  "VIVILLONHIGHPLAINS": { rarity: "hatch", types: ["bug", "amorphous", "human"], additional: false, regional: false, stars: 1 },
  "VIVILLONICYSNOW": { rarity: "hatch", types: ["bug", "amorphous", "normal"], additional: false, regional: false, stars: 1 },
  "VIVILLONJUNGLE": { rarity: "hatch", types: ["bug", "amorphous", "poison"], additional: false, regional: false, stars: 1 },
  "VIVILLONMARINE": { rarity: "hatch", types: ["bug", "amorphous", "water"], additional: false, regional: false, stars: 1 },
  "VIVILLONMODERN": { rarity: "hatch", types: ["bug", "amorphous", "field"], additional: false, regional: false, stars: 1 },
  "VIVILLONMONSOON": { rarity: "hatch", types: ["bug", "amorphous", "steel"], additional: false, regional: false, stars: 1 },
  "VIVILLONOCEAN": { rarity: "hatch", types: ["bug", "amorphous", "light"], additional: false, regional: false, stars: 1 },
  "VIVILLONPOKEBALL": { rarity: "hatch", types: ["bug", "amorphous", "artificial"], additional: false, regional: false, stars: 1 },
  "VIVILLONPOLAR": { rarity: "hatch", types: ["bug", "amorphous", "ghost"], additional: false, regional: false, stars: 1 },
  "VIVILLONRIVER": { rarity: "hatch", types: ["bug", "amorphous", "aquatic"], additional: false, regional: false, stars: 1 },
  "VIVILLONSANDSTORM": { rarity: "hatch", types: ["bug", "amorphous", "rock"], additional: false, regional: false, stars: 1 },
  "VIVILLONSAVANNA": { rarity: "hatch", types: ["bug", "amorphous", "electric"], additional: false, regional: false, stars: 1 },
  "VIVILLONSUN": { rarity: "hatch", types: ["bug", "amorphous", "fire"], additional: false, regional: false, stars: 1 },
  "VIVILLONTUNDRA": { rarity: "hatch", types: ["bug", "amorphous", "ice"], additional: false, regional: false, stars: 1 },
  ...
  "WOOLOO": { rarity: "uncommon", types: ["normal", "field"], additional: true, regional: false, stars: 1 },
  ...
  "YAMPER": { rarity: "uncommon", types: ["electric", "field"], additional: true, regional: false, stars: 1 },
